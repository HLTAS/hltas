...
const _: () = {
    ...
    ["Alignment of AlgorithmParameters__bindgen_ty_1__bindgen_ty_1"]
        [::std::mem::align_of::<AlgorithmParameters__bindgen_ty_1__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of AlgorithmParameters__bindgen_ty_1__bindgen_ty_2"]
        [::std::mem::align_of::<AlgorithmParameters__bindgen_ty_1__bindgen_ty_2>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of AlgorithmParameters__bindgen_ty_1__bindgen_ty_3"]
        [::std::mem::align_of::<AlgorithmParameters__bindgen_ty_1__bindgen_ty_3>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of AlgorithmParameters__bindgen_ty_1__bindgen_ty_4"]
        [::std::mem::align_of::<AlgorithmParameters__bindgen_ty_1__bindgen_ty_4>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of AlgorithmParameters__bindgen_ty_1__bindgen_ty_5"]
        [::std::mem::align_of::<AlgorithmParameters__bindgen_ty_1__bindgen_ty_5>() - 4usize];
...
const _: () = {
    ["Size of AlgorithmParameters__bindgen_ty_1__bindgen_ty_6"]
        [::std::mem::size_of::<AlgorithmParameters__bindgen_ty_1__bindgen_ty_6>() - 28usize];
    ["Alignment of AlgorithmParameters__bindgen_ty_1__bindgen_ty_6"]
        [::std::mem::align_of::<AlgorithmParameters__bindgen_ty_1__bindgen_ty_6>() - 4usize];
    ...
    ["Offset of field: AlgorithmParameters__bindgen_ty_1__bindgen_ty_6::X"]
        [::std::mem::offset_of!(AlgorithmParameters__bindgen_ty_1__bindgen_ty_6, X) - 4usize];
    ["Offset of field: AlgorithmParameters__bindgen_ty_1__bindgen_ty_6::Y"]
        [::std::mem::offset_of!(AlgorithmParameters__bindgen_ty_1__bindgen_ty_6, Y) - 12usize];
    ["Offset of field: AlgorithmParameters__bindgen_ty_1__bindgen_ty_6::Z"]
        [::std::mem::offset_of!(AlgorithmParameters__bindgen_ty_1__bindgen_ty_6, Z) - 20usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AlgorithmParameters__bindgen_ty_1"]
        [::std::mem::size_of::<AlgorithmParameters__bindgen_ty_1>() - 28usize];
    ["Alignment of AlgorithmParameters__bindgen_ty_1"]
        [::std::mem::align_of::<AlgorithmParameters__bindgen_ty_1>() - 4usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of AlgorithmParameters"][::std::mem::size_of::<AlgorithmParameters>() - 32usize];
    ["Alignment of AlgorithmParameters"][::std::mem::align_of::<AlgorithmParameters>() - 4usize];
    ...
    ["Offset of field: AlgorithmParameters::Parameters"]
        [::std::mem::offset_of!(AlgorithmParameters, Parameters) - 4usize];
};
#[repr(u8)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of hltas_frame"][::std::mem::size_of::<hltas_frame>() - 276usize];
    ["Alignment of hltas_frame"][::std::mem::align_of::<hltas_frame>() - 4usize];
    ...
    ["Offset of field: hltas_frame::Yaw"][::std::mem::offset_of!(hltas_frame, Yaw) - 68usize];
    ["Offset of field: hltas_frame::X"][::std::mem::offset_of!(hltas_frame, X) - 76usize];
    ["Offset of field: hltas_frame::Y"][::std::mem::offset_of!(hltas_frame, Y) - 84usize];
    ["Offset of field: hltas_frame::Count"][::std::mem::offset_of!(hltas_frame, Count) - 92usize];
    ["Offset of field: hltas_frame::Yawspeed"]
        [::std::mem::offset_of!(hltas_frame, Yawspeed) - 96usize];
    ["Offset of field: hltas_frame::StartYawOffset"]
        [::std::mem::offset_of!(hltas_frame, StartYawOffset) - 104usize];
    ["Offset of field: hltas_frame::TargetYawOffset"]
        [::std::mem::offset_of!(hltas_frame, TargetYawOffset) - 112usize];
    ["Offset of field: hltas_frame::Acceleration"]
        [::std::mem::offset_of!(hltas_frame, Acceleration) - 120usize];
    ["Offset of field: hltas_frame::Pitch"][::std::mem::offset_of!(hltas_frame, Pitch) - 128usize];
    ["Offset of field: hltas_frame::Repeats"]
        [::std::mem::offset_of!(hltas_frame, Repeats) - 136usize];
    ["Offset of field: hltas_frame::Commands"]
        [::std::mem::offset_of!(hltas_frame, Commands) - 140usize];
    ["Offset of field: hltas_frame::Comments"]
        [::std::mem::offset_of!(hltas_frame, Comments) - 144usize];
    ["Offset of field: hltas_frame::SaveName"]
        [::std::mem::offset_of!(hltas_frame, SaveName) - 148usize];
    ["Offset of field: hltas_frame::SeedPresent"]
        [::std::mem::offset_of!(hltas_frame, SeedPresent) - 152usize];
    ["Offset of field: hltas_frame::Seed"][::std::mem::offset_of!(hltas_frame, Seed) - 156usize];
    ["Offset of field: hltas_frame::BtnState"]
        [::std::mem::offset_of!(hltas_frame, BtnState) - 160usize];
    ["Offset of field: hltas_frame::Buttons"]
        [::std::mem::offset_of!(hltas_frame, Buttons) - 161usize];
    ["Offset of field: hltas_frame::LgagstMinSpeedPresent"]
        [::std::mem::offset_of!(hltas_frame, LgagstMinSpeedPresent) - 165usize];
    ["Offset of field: hltas_frame::LgagstMinSpeed"]
        [::std::mem::offset_of!(hltas_frame, LgagstMinSpeed) - 168usize];
    ["Offset of field: hltas_frame::ResetFrame"]
        [::std::mem::offset_of!(hltas_frame, ResetFrame) - 172usize];
    ["Offset of field: hltas_frame::ResetNonSharedRNGSeed"]
        [::std::mem::offset_of!(hltas_frame, ResetNonSharedRNGSeed) - 176usize];
    ["Offset of field: hltas_frame::StrafingAlgorithmPresent"]
        [::std::mem::offset_of!(hltas_frame, StrafingAlgorithmPresent) - 184usize];
    ["Offset of field: hltas_frame::Algorithm"]
        [::std::mem::offset_of!(hltas_frame, Algorithm) - 188usize];
    ["Offset of field: hltas_frame::AlgorithmParametersPresent"]
        [::std::mem::offset_of!(hltas_frame, AlgorithmParametersPresent) - 192usize];
    ["Offset of field: hltas_frame::Parameters"]
        [::std::mem::offset_of!(hltas_frame, Parameters) - 196usize];
    ["Offset of field: hltas_frame::ChangePresent"]
        [::std::mem::offset_of!(hltas_frame, ChangePresent) - 228usize];
    ["Offset of field: hltas_frame::Target"]
        [::std::mem::offset_of!(hltas_frame, Target) - 229usize];
    ["Offset of field: hltas_frame::ChangeFinalValue"]
        [::std::mem::offset_of!(hltas_frame, ChangeFinalValue) - 232usize];
    ["Offset of field: hltas_frame::ChangeOver"]
        [::std::mem::offset_of!(hltas_frame, ChangeOver) - 236usize];
    ["Offset of field: hltas_frame::TargetYawOverride"]
        [::std::mem::offset_of!(hltas_frame, TargetYawOverride) - 240usize];
    ["Offset of field: hltas_frame::TargetYawOverrideCount"]
        [::std::mem::offset_of!(hltas_frame, TargetYawOverrideCount) - 244usize];
    ["Offset of field: hltas_frame::RenderYawOverride"]
        [::std::mem::offset_of!(hltas_frame, RenderYawOverride) - 248usize];
    ["Offset of field: hltas_frame::RenderYawOverrideCount"]
        [::std::mem::offset_of!(hltas_frame, RenderYawOverrideCount) - 252usize];
    ["Offset of field: hltas_frame::PitchOverride"]
        [::std::mem::offset_of!(hltas_frame, PitchOverride) - 256usize];
    ["Offset of field: hltas_frame::PitchOverrideCount"]
        [::std::mem::offset_of!(hltas_frame, PitchOverrideCount) - 260usize];
    ["Offset of field: hltas_frame::RenderPitchOverride"]
        [::std::mem::offset_of!(hltas_frame, RenderPitchOverride) - 264usize];
    ["Offset of field: hltas_frame::RenderPitchOverrideCount"]
        [::std::mem::offset_of!(hltas_frame, RenderPitchOverrideCount) - 268usize];
    ["Offset of field: hltas_frame::IgnoreSmoothing"]
        [::std::mem::offset_of!(hltas_frame, IgnoreSmoothing) - 272usize];
};
