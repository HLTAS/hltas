...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of hltas_frame"][::std::mem::size_of::<hltas_frame>() - 360usize];
    ...
    ["Offset of field: hltas_frame::Frametime"]
        [::std::mem::offset_of!(hltas_frame, Frametime) - 64usize];
    ["Offset of field: hltas_frame::PitchPresent"]
        [::std::mem::offset_of!(hltas_frame, PitchPresent) - 72usize];
    ["Offset of field: hltas_frame::YawPresent"]
        [::std::mem::offset_of!(hltas_frame, YawPresent) - 73usize];
    ["Offset of field: hltas_frame::Yaw"][::std::mem::offset_of!(hltas_frame, Yaw) - 80usize];
    ["Offset of field: hltas_frame::X"][::std::mem::offset_of!(hltas_frame, X) - 88usize];
    ["Offset of field: hltas_frame::Y"][::std::mem::offset_of!(hltas_frame, Y) - 96usize];
    ["Offset of field: hltas_frame::Count"][::std::mem::offset_of!(hltas_frame, Count) - 104usize];
    ["Offset of field: hltas_frame::Yawspeed"]
        [::std::mem::offset_of!(hltas_frame, Yawspeed) - 112usize];
    ["Offset of field: hltas_frame::StartYawOffset"]
        [::std::mem::offset_of!(hltas_frame, StartYawOffset) - 120usize];
    ["Offset of field: hltas_frame::TargetYawOffset"]
        [::std::mem::offset_of!(hltas_frame, TargetYawOffset) - 128usize];
    ["Offset of field: hltas_frame::Acceleration"]
        [::std::mem::offset_of!(hltas_frame, Acceleration) - 136usize];
    ["Offset of field: hltas_frame::Pitch"][::std::mem::offset_of!(hltas_frame, Pitch) - 144usize];
    ["Offset of field: hltas_frame::Repeats"]
        [::std::mem::offset_of!(hltas_frame, Repeats) - 152usize];
    ["Offset of field: hltas_frame::Commands"]
        [::std::mem::offset_of!(hltas_frame, Commands) - 160usize];
    ["Offset of field: hltas_frame::Comments"]
        [::std::mem::offset_of!(hltas_frame, Comments) - 168usize];
    ["Offset of field: hltas_frame::SaveName"]
        [::std::mem::offset_of!(hltas_frame, SaveName) - 176usize];
    ["Offset of field: hltas_frame::SeedPresent"]
        [::std::mem::offset_of!(hltas_frame, SeedPresent) - 184usize];
    ["Offset of field: hltas_frame::Seed"][::std::mem::offset_of!(hltas_frame, Seed) - 188usize];
    ["Offset of field: hltas_frame::BtnState"]
        [::std::mem::offset_of!(hltas_frame, BtnState) - 192usize];
    ["Offset of field: hltas_frame::Buttons"]
        [::std::mem::offset_of!(hltas_frame, Buttons) - 193usize];
    ["Offset of field: hltas_frame::LgagstMinSpeedPresent"]
        [::std::mem::offset_of!(hltas_frame, LgagstMinSpeedPresent) - 197usize];
    ["Offset of field: hltas_frame::LgagstMinSpeed"]
        [::std::mem::offset_of!(hltas_frame, LgagstMinSpeed) - 200usize];
    ["Offset of field: hltas_frame::ResetFrame"]
        [::std::mem::offset_of!(hltas_frame, ResetFrame) - 204usize];
    ["Offset of field: hltas_frame::ResetNonSharedRNGSeed"]
        [::std::mem::offset_of!(hltas_frame, ResetNonSharedRNGSeed) - 208usize];
    ["Offset of field: hltas_frame::StrafingAlgorithmPresent"]
        [::std::mem::offset_of!(hltas_frame, StrafingAlgorithmPresent) - 216usize];
    ["Offset of field: hltas_frame::Algorithm"]
        [::std::mem::offset_of!(hltas_frame, Algorithm) - 220usize];
    ["Offset of field: hltas_frame::AlgorithmParametersPresent"]
        [::std::mem::offset_of!(hltas_frame, AlgorithmParametersPresent) - 224usize];
    ["Offset of field: hltas_frame::Parameters"]
        [::std::mem::offset_of!(hltas_frame, Parameters) - 232usize];
    ["Offset of field: hltas_frame::ChangePresent"]
        [::std::mem::offset_of!(hltas_frame, ChangePresent) - 272usize];
    ["Offset of field: hltas_frame::Target"]
        [::std::mem::offset_of!(hltas_frame, Target) - 273usize];
    ["Offset of field: hltas_frame::ChangeFinalValue"]
        [::std::mem::offset_of!(hltas_frame, ChangeFinalValue) - 276usize];
    ["Offset of field: hltas_frame::ChangeOver"]
        [::std::mem::offset_of!(hltas_frame, ChangeOver) - 280usize];
    ["Offset of field: hltas_frame::TargetYawOverride"]
        [::std::mem::offset_of!(hltas_frame, TargetYawOverride) - 288usize];
    ["Offset of field: hltas_frame::TargetYawOverrideCount"]
        [::std::mem::offset_of!(hltas_frame, TargetYawOverrideCount) - 296usize];
    ["Offset of field: hltas_frame::RenderYawOverride"]
        [::std::mem::offset_of!(hltas_frame, RenderYawOverride) - 304usize];
    ["Offset of field: hltas_frame::RenderYawOverrideCount"]
        [::std::mem::offset_of!(hltas_frame, RenderYawOverrideCount) - 312usize];
    ["Offset of field: hltas_frame::PitchOverride"]
        [::std::mem::offset_of!(hltas_frame, PitchOverride) - 320usize];
    ["Offset of field: hltas_frame::PitchOverrideCount"]
        [::std::mem::offset_of!(hltas_frame, PitchOverrideCount) - 328usize];
    ["Offset of field: hltas_frame::RenderPitchOverride"]
        [::std::mem::offset_of!(hltas_frame, RenderPitchOverride) - 336usize];
    ["Offset of field: hltas_frame::RenderPitchOverrideCount"]
        [::std::mem::offset_of!(hltas_frame, RenderPitchOverrideCount) - 344usize];
    ["Offset of field: hltas_frame::IgnoreSmoothing"]
        [::std::mem::offset_of!(hltas_frame, IgnoreSmoothing) - 352usize];
};
